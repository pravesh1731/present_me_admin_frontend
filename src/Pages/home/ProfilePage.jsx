  ...
  const toggleEdit = async () => {
    if (editing) {
      ...
      try {
        ...
        if (profilePicFile) {
          // the field name must match multer.single("profilePicUrl")
          formData.append("profilePicUrl", profilePicFile);
        }
        ...
        // Only update user if response is valid
    ...
    <div className="space-y-6">
      <div>
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={toggleEdit}
            className={`px-4 py-2 rounded-md flex items-center justify-center min-w-[120px] ${
              editing
                ? "bg-gradient-to-br from-[#7c4dff] to-[#6b46c1] text-white"
      ...
      <div className="grid grid-cols-12 gap-6 items-start">
        <div
          className={`col-span-12 ${
            tab === "profile" ? "lg:col-span-8" : "lg:col-span-12"
          }`}
        >
          {tab === "profile" && (
            <div className="bg-gradient-to-br from-white to-[#f3f2ff] rounded-xl p-6 shadow-sm">
              ...
              <div className="flex items-center gap-6 mb-6">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#0bcceb] to-[#0a80f5] flex items-center justify-center overflow-hidden">
                  {profilePicUrl ? (
                    <img
                      src={profilePicUrl}
                      alt="Profile"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg border px-3 py-2 border-transparent bg-gray-50`}
                  />
                </div>
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="border-t pt-4 space-y-4">
                  <div className="flex items-start justify-between">
                    ...
                    <div>
                      <button className="px-3 py-2 rounded-md border border-green-200 text-green-600 bg-green-50">
                        Enable 2FA
                      </button>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-4">
                      <button className="w-full text-center px-4 py-2 rounded-md border border-red-200 text-red-600 bg-red-50">
          ...
          {tab === "activity" && (
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              <div className="bg-green-50 p-6">
                ...
                <p className="text-sm text-gray-500">
                  Recent actions and system activity
                </p>
              </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="p-4 rounded-lg border border-gray-100 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">
                      December 2023 Attendance Summary
                    </div>
                    <div className="text-xs text-gray-400 mt-1">
                      15/01/2024, 10:20:00
                    </div>
                ...
                <div className="p-4 rounded-lg border border-gray-100 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">
                      Grade 11 Biology class attendance
                    </div>
                    <div className="text-xs text-gray-400 mt-1">
                      14/01/2024, 09:30:00
                    </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="font-medium">{new Date(user.createdAt).toLocaleString("en-GB")}
                  </div>
                </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {permissions.map((p) => (
                      <div
                        key={p}
                        className="text-xs px-2 py-1 rounded-full bg-[#f3f2ff] text-[#6b46c1]"
                      >
                        {p}
                      </div>
                    ))}
