      ...
      {selectedTeacher && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div
            role="dialog"
            aria-modal="true"
            className="relative z-10 w-[90%] md:w-[540px] bg-white rounded-xl shadow-xl p-6"
          >
            <div className="flex items-start justify-between">
              <div>
              ...
              <button
                onClick={closeTeacher}
                className="text-gray-500 bg-gray-100 rounded-full p-1.5 hover:bg-gray-200"
              >
            ...
            <div className="mt-4 text-sm text-gray-700">
              {selectedTeacher.profilePicUrl && (
                <div className="mb-4 flex justify-center">
                  <img
                    src={selectedTeacher.profilePicUrl}
              ...
              <div className="mb-3">
                ...
                <div>{selectedTeacher.emailId}</div>
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <div>{selectedTeacher.empId || "—"}</div>
              </div>
              <div className="mb-3">
                <span className="font-medium">Specialization:</span>
                <div>{selectedTeacher.specialization || "—"}</div>
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <div>{selectedTeacher.officeLocation || "—"}</div>
              </div>
              <div className="mb-3">
                <span className="font-medium">Hotspot:</span>
                <div>{selectedTeacher.hotspotName || "—"}</div>
              </div>
              <div className="mb-3">
                <span className="font-medium">Joined:</span>
                <div>{selectedTeacher.createdAt?.slice(0, 10)}</div>
              </div>
            </div>
          </div>
        </div>
