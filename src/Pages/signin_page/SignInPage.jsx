    ...
    <div className="min-h-screen flex items-start justify-center px-4 py-12 bg-gradient-to-br from-white via-[#0BCCEB]/10 to-[#0A80F5]/10">
      <div className="w-full max-w-lg">
        <div className="flex flex-col items-center mb-6">
          <div className="bg-gradient-to-br from-[#0BCCEB] to-[#0A80F5] p-3 rounded-xl shadow-md">
            <svg className="w-10 h-10 text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M2 22c0-5.523 4.477-10 10-10s10 4.477 10 10" stroke="rgba(255,255,255,0.6)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>

          <h2 className="mt-6 text-3xl font-bold text-gray-900">Present-Me Admin</h2>
              ...
              <div className="space-y-4">
                  ...
                  <div className="relative">
                    <span className="absolute inset-y-0 left-3 flex items-center text-gray-300">
                      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M22 7l-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </span>
                    <input className="block w-full pl-10 pr-3 py-2 rounded-lg border border-gray-200 bg-white text-sm" type="email" placeholder="admin@present_me.gmail.com" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input className="block w-full pl-10 pr-10 py-2 rounded-lg border border-gray-200 bg-white text-sm" type={showPassword ? "text" : "password"} placeholder="Enter your password" />
                    <button
          type="button"
        ...
        >
            ...
            >
              ...
              />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a href='/forget_password' className="text-sm text-[#0A80F5]">Forgot password?</a>
                </div>

                <div>
                  <button type="submit" onClick={() => navigate("/")} className="w-full py-3 rounded-lg text-white font-medium shadow-md bg-gradient-to-r from-[#0BCCEB] to-[#0A80F5]">Sign In</button>
                </div>

                <div className="pt-4 border-t border-gray-100 text-center">
                  <p className="text-sm text-gray-600">Don't have an account? <a href='/signup' className="text-[#0A80F5]">Create one here</a></p>
          ...
          <p className="mt-6 text-center text-xs text-gray-500">© 2024 Present-Me. All rights reserved.</p>
        </div>
      </div>
    </div>
  )
