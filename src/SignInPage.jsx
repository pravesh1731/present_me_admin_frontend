    ...
    <div className="min-h-screen flex items-start justify-center px-4 py-12 bg-gradient-to-br from-white via-[#0BCCEB]/10 to-[#0A80F5]/10">
      <div className="w-full max-w-lg">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="mt-2 text-gray-600">Sign in to your admin accoun</p>
        </div>
            ...
            <form className="px-6 py-6 sm:px-8 sm:py-8">
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      type="email"
                      placeholder="admin@attendanceapp.edu"
                      defaultValue="admin@attendanceapp.edu"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a className="text-sm text-[#0A80F5]">Forgot password?</a>
                </div>
                ...
                <div className="pt-4 border-t border-gray-100 text-center">
                  <p className="text-sm text-gray-600">
                    ...
                    <a className="text-[#0A80F5]">Create one here</a>
                  </p>
                  <p className="mt-3 text-xs text-gray-500">
                    Demo Credentials:
                    <br />
                    Email: admin@attendanceapp.edu
                    <br />
                    Password: admin123
                  </p>
                </div>
